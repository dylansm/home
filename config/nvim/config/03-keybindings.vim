...
\  'down':    '40%'})
 ...
 function! OpenInMarked()
   " Get the name of the currentfile
   let l:current_file = expand('%:p')

   " Check if the file exists and is a Markdown file
   if filereadable(l:current_file) && l:current_file =~ '\.md$'
     " Execute the command to open in Marked
     execute '!open -a "Marked 2" ' . l:current_file
   else
     echo "Not a valid Markdown file."
   endif
 endfunction

 "nmap <silent>;m :OpenInMarked!<CR>
 nnoremap <silent>;m :call OpenInMarked()<CR>
